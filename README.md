...
# How To STOP Sorting Your Downloads AND set the folder back to its original state
...
# How To STOP Sorting Your Downloads, but keep your downloads directory the as is
